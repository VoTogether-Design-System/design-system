...
`;function e({theme:r,children:y,...f}){return o(k,{$theme:r,...f,children:y})}try{e.displayName="SquareButton",e.__docgenInfo={description:"",displayName:"SquareButton",props:{theme:{defaultValue:null,description:"",name:"theme",required:!0,type:{name:"enum",value:[{value:'"fill"'},{value:'"blank"'},{value:'"gray"'}]}}}}}catch{}const C={component:e,decorators:[r=>o("div",{style:{width:"100px",height:"50px"},children:r()})]},t={render:()=>o(e,{theme:"blank",children:"확 인"})},a={render:()=>o(e,{theme:"fill",children:"버 튼"})},n={render:()=>o(e,{theme:"gray",children:"버 튼"})};var l,s,c;t.parameters={...t.parameters,docs:{...(l=t.parameters)==null?void 0:l.docs,source:{originalSource:`{
...
//# sourceMappingURL=SquareButton.stories-a6b9da18.js.map
